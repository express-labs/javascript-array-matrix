...
var mutate = function mutate(data, mutators) {
  var mutations = pipe(mutators);
...
var sizeExtensionMutation = function sizeExtensionMutation(data) {
  return data.map(function (item) {
    var extension = item.sizeExtension2 || 'Regular';

    return _extends({}, item, { extension: extension });
  });
};

var sizeNameMutation = function sizeNameMutation(data) {
  return data.map(function (item) {
    var sizeName = function (name) {
    ...
    return _extends({}, item, { size: sizeName });
  });
};

var waistInseamMutation = function waistInseamMutation(data) {
  return data.map(function (item) {
    var sizeSplitter = item.sizeName.split(' ');
...
var ArrayMatrix$1 = function ArrayMatrix() {
    ...
    */
    data.forEach(function (item) {
      ...
      while (pointer < props.order) {
        var order = orders[pointer];
        var index = getAxisPoint(order, item[order], plane); // eslint-disable-line
        plane = plane[index];
  ...
  function getTuple(points) {
    ...
    var tuple = new Array(props.order).fill(null);

    for (var i = 0, l = keys.length; i < l; i++) {
      // eslint-disable-line no-plusplus
      var key = keys[i];
      var mIndex = props.orders.indexOf(key);
...
var s = { "headline": "_headline_11gil_67", "slider": "_slider_11gil_71", "verticalSlider": "_verticalSlider_11gil_75" };
...
var DevelopmentApp = function (_React$Component) {
  ...
  createClass(DevelopmentApp, null, [{
    key: 'getQueryTable',
    value: function getQueryTable(tensor, headers, query) {
      var method = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'getDimension';

      var queryTime = void 0;
      var scalars = function () {
        var start = performance.now();
        var resultSet = tensor[method](query);
      ...
      return react.createElement(
        ...
        react.createElement(
          ...
          react.createElement(
            ...
            scalars.map(function (scalar, idx) {
              return react.createElement(
                'tr',
                { key: 'tr-' + idx },
                react.createElement(
                ...
                headers.map(function (header, tdidx) {
                  return scalar ? react.createElement(
                    'td',
                    { key: 'td-' + idx + '-' + tdidx },
                    scalar[header]
                  ) : react.createElement(
  ...
  createClass(DevelopmentApp, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState(function () {
        ...
        Object.keys(configs).forEach(function (key) {
          var start = performance.now();
          tensors[key] = new ArrayMatrix$1(configs[key]);
          var end = performance.now();
          perf[key] = end - start;
        });
    ...
    value: function render() {
      ...
      return react.createElement(
        ...
        react.createElement(
          'select',
          { className: s.select, value: this.state.value, onChange: this.handleChange },
          react.createElement(
            'option',
            { value: '0' },
            'Color and Sizes'
          ...
          react.createElement(
            'option',
            { value: '1' },
            'Color, Size Extensions, and Sizes'
          ),
          react.createElement(
            'option',
            { value: '2' },
            'Color, Waist, and Inseam'
          ),
          react.createElement(
            'option',
            { value: '3' },
            'Color, Size Extensions, Waist, and Inseam'
          ),
          react.createElement(
            'option',
            { value: '4' },
        ...
        this.state.value === '0' && react.createElement(
          ...
          react.createElement(
            'h2',
            null,
            '2 Order Matrix: Color and Sizes'
          ),
          colorSizesData && react.createElement(
            'div',
            null,
            react.createElement(
              'h3',
            ...
            react.createElement(
              'pre',
              null,
              'Data parsed in ' + this.state.perf.colorSizesData + ' milliseconds.'
            ),
            react.createElement(
              'h3',
              null,
            ...
            react.createElement(
              'pre',
              null,
              '{ size: \'XXL\', colorName: \'COBALT BLUE\' }'
            ),
            DevelopmentApp.getQueryTable(colorSizesData, ['skuId', 'colorName', 'size'], { size: 'XXL', colorName: 'COBALT BLUE' }, 'getEntry')
          )
        ),
        this.state.value === '1' && react.createElement(
          'section',
          { id: 'example--1' },
          react.createElement(
            'h2',
            null,
            '3 Order Matrix: Color, Size Extensions, and Sizes'
          ),
          sizeExtensionsData && react.createElement(
            'div',
            null,
            react.createElement(
              'h3',
            ...
            react.createElement(
              'h4',
              null,
              'Query by colorName and extension'
            ),
            react.createElement(
              'pre',
              null,
              '{ colorName: \'NAVY\', extension: \'Regular\' }'
            ),
            ...
            react.createElement(
              'pre',
              null,
              '{ colorName: \'RUBY RED\', extension: \'Tall\' }'
            ),
            ...
            react.createElement(
              'pre',
              null,
              '{ size: \'S\', colorName: \'NAVY\', extension: \'Regular\' }'
            ),
            ...
            react.createElement(
              'pre',
              null,
              '{ size: \'S\', colorName: \'BLACK\', extension: \'Tall\' }'
            ),
            DevelopmentApp.getQueryTable(sizeExtensionsData, ['skuId', 'colorName', 'size'], { size: 'S', colorName: 'BLACK', extension: 'Tall' }, 'getEntry')
          )
        ),
        this.state.value === '2' && react.createElement(
          'section',
          { id: 'example--2' },
          react.createElement(
            'h2',
            null,
            '3 Order Matrix: Color, Waist, and Inseam'
          ),
          waistInseamData && react.createElement(
            'div',
            null,
            react.createElement(
              'h3',
            ...
            react.createElement(
              'pre',
              null,
              'Data parsed in ' + this.state.perf.waistInseamData + ' milliseconds.'
            ),
            react.createElement(
              'h3',
              null,
            ...
            react.createElement(
              'h4',
              null,
              'Query by colorName and waist'
            ),
            react.createElement(
              'pre',
              null,
              '{ colorName: \'BLUE\', waist: \'W30\' }'
            ),
            ...
            react.createElement(
              'h4',
              null,
              'Query by colorName and inseam'
            ),
            react.createElement(
              'pre',
              null,
              '{ colorName: \'BLUE\', inseam: \'L30\' }'
            ),
            ...
            react.createElement(
              'h4',
              null,
              'Query by waist and inseam'
            ),
            react.createElement(
              'pre',
              null,
              '{ waist: \'W30\', inseam: \'L30\' }'
            ),
            ...
            react.createElement(
              'pre',
              null,
              '{ waist: \'W28\', colorName: \'BLUE\', inseam: \'L30\' }'
            ),
            ...
            react.createElement(
              'pre',
              null,
              '{ waist: \'W36\', colorName: \'BLUE\', inseam: \'L28\' }'
            ),
        ...
        this.state.value === '3' && react.createElement(
          'section',
          { id: 'example--3' },
          react.createElement(
            'h2',
            null,
            '4 Order Matrix: Color, Size Extensions, Waist, and Inseam'
          ),
          waistInseamData && react.createElement(
            'div',
            null,
            ...
            react.createElement(
              'pre',
              null,
              'Data parsed in ' + this.state.perf.waistSizeExtensionsData + ' milliseconds.'
            ),
            react.createElement(
              'h3',
              null,
            ...
            react.createElement(
              'pre',
              null,
              '{ colorName: \'BLUE\', extension: \'Regular\', waist: \'W30\' }'
            ),
            ...
            react.createElement(
              'h4',
              null,
              'Query by colorName, extension, and inseam'
            ),
            react.createElement(
              'pre',
              null,
              '{ colorName: \'BLUE\', extension: \'Regular\', inseam: \'L30\' }'
            ),
            ...
            react.createElement(
              'h4',
              null,
              'Query by colorName, waist, and inseam'
            ),
            react.createElement(
              'pre',
              null,
              '{ colorName: \'BLUE\', waist: \'W30\', inseam: \'L30\' }'
            ),
            ...
            react.createElement(
              'h4',
              null,
              'Query by extension, waist, and inseam'
            ),
            react.createElement(
              'pre',
              null,
              '{ extension: \'Regular\', waist: \'W30\', inseam: \'L30\' }'
            ),
        ...
        this.state.value === '4' && react.createElement(
          'section',
          { id: 'example--4' },
          react.createElement(
            'h2',
            null,
            '4 Order Matrix: Waist, Inseam, Size Extensions, and Color'
          ),
          waistInseamData && react.createElement(
            'div',
            null,
            ...
            react.createElement(
              'pre',
              null,
              'Data parsed in ' + this.state.perf.waistSizeExtensionsColorData + ' milliseconds.'
            ),
            react.createElement(
              'h3',
              null,
